...
POINTS: list[tuple[str, str | None, str, str, str, str, int]] = [
    ...
    ("literature.author_work", "literature", "作家与作品对应", "Авторы и произведения", "literature", "作家、代表作、人物、名句和作品背景的对应关系。", 310),
    ("literature.periods", "literature", "文学史时期", "Периоды литературы", "literature", "古代文学、18 世纪、19 世纪、白银时代、苏联文学和当代文学。", 320),
    ("literature.classical_19c", "literature", "19 世纪经典文学", "Классическая литература XIX века", "literature", "普希金、莱蒙托夫、果戈理、屠格涅夫、陀思妥耶夫斯基、托尔斯泰、契诃夫等。", 330),
    ("literature.silver_age", "literature", "白银时代与现代主义", "Серебряный век и модернизм", "literature", "象征主义、阿克梅派、未来主义及代表作家。", 340),
    ("literature.soviet", "literature", "苏联文学", "Советская литература", "literature", "苏联时期主要作家、作品、文学流派和时代主题。", 350),
    ("literature.genre_terms", "literature", "体裁、流派与文学术语", "Жанры, направления и термины", "literature", "小说、诗歌、戏剧、现实主义、浪漫主义、讽刺等术语。", 360),
