...
def export_review_sheet(output_path: Path, years: list[int] | None) -> dict[str, Any]:
    ...
    return {"output": str(output_path), "rows": len(rows), "years": years or "all"}
...
def main() -> None:
    ...
    result = export_review_sheet(args.output, args.year)
