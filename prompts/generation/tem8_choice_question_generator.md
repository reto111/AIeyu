...
- 国情 `difficulty = 4` 的合格方向：题干应要求考生同时判断事实节点和背景关系，例如“莫斯科成为首都的关键时间节点 + 1918/1922 等易混年份辨析”。不要把 difficulty=4 做成单纯名称对应题，例如只问某建筑、钟、塔或广场的名称。
- 地理、资源、河流湖泊类国情 `difficulty = 4` 必须做组合判断：每题至少综合两个事实维度，例如“河流流向 + 注入海域”“资源种类 + 主要产区”“地理分界 + 资源/行政区域”。题干应明确写出“对应关系”“组合判断”“综合辨析”等任务，不要只问“哪条河最长”“某资源居第几位”“下列关于某事物哪一项正确”。
- 如果同一知识块里已经存在原题式单点问法，必须把它改造成新的综合辨析题，不要复制原题题干、选项结构或只替换干扰项。
